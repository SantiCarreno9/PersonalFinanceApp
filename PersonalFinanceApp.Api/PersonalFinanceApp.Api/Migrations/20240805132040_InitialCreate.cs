    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<byte>(type: "INTEGER", nullable: false),
                    TransactionTypeId = table.Column<byte>(type: "INTEGER", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "nvarchar(100)", nullable: false, defaultValue: "Unknown"),
                    CategoryId = table.Column<byte>(type: "INTEGER", nullable: false),
                    TransactionTypeId = table.Column<byte>(type: "INTEGER", nullable: false, defaultValue: (byte)1),
                    PaymentMethodId = table.Column<byte>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
